...
var ASM_CONSTS = {
  125000: () => { if (document.fullscreenElement) return 1; },  
 125046: () => { return document.getElementById('canvas').width; },  
 125098: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125166: () => { document.exitFullscreen(); },  
 125193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125266: () => { if (document.fullscreenElement) return 1; },  
 125312: () => { return document.getElementById('canvas').width; },  
 125364: () => { return screen.width; },  
 125389: () => { document.exitFullscreen(); },  
 125416: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 125549: () => { return window.innerWidth; },  
 125575: () => { return window.innerHeight; },  
 125602: () => { if (document.fullscreenElement) return 1; },  
 125648: () => { return document.getElementById('canvas').width; },  
 125700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125768: () => { if (document.fullscreenElement) return 1; },  
 125814: () => { return document.getElementById('canvas').width; },  
 125866: () => { return screen.width; },  
 125891: () => { return window.innerWidth; },  
 125917: () => { return window.innerHeight; },  
 125944: () => { if (document.fullscreenElement) return 1; },  
 125990: () => { return document.getElementById('canvas').width; },  
 126042: () => { return screen.width; },  
 126067: () => { document.exitFullscreen(); },  
 126094: () => { if (document.fullscreenElement) return 1; },  
 126140: () => { return document.getElementById('canvas').width; },  
 126192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126260: () => { document.exitFullscreen(); },  
 126287: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126345: () => { return screen.width; },  
 126370: () => { return screen.height; },  
 126396: () => { return window.screenX; },  
 126423: () => { return window.screenY; },  
 126450: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126503: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 126574: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 126631: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126887: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126958: () => { if (document.fullscreenElement) return 1; },  
 127004: () => { return window.innerWidth; },  
 127030: () => { return window.innerHeight; },  
 127057: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
